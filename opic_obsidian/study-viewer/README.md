...
처음 한 번 GitHub 저장소의 `Settings > Pages`에서 배포 방식을 `GitHub Actions`로 선택합니다. 이후 `OPIc-publish.bat`을 더블클릭하면 Markdown 변경사항을 반영하고 GitHub Pages 배포를 요청합니다.
...
- `OPIc-publish.bat`: 업데이트 내용을 GitHub Pages에 공개
